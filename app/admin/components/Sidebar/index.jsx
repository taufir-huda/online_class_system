...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside ref={sidebar} className={`absolute top-0 left-0 z-999 flex bg-black h-screen w-72.5 flex-col overflow-y-hidden duration-300 ease-linear dark:bg-boxdark sm:sticky ${ sidebarOpen ? "translate-x-0" : "-translate-x-full" }`}>
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link  href="../../admin/teachers"  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${ pathname.includes("calendar") &&  "bg-graydark dark:bg-meta-4"}`} >
                  <svg className="fill-current"  width="18"  height="18"  viewBox="-18 -18 36 36"  fill="none"  xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.9,15.2c0-8.4-7.4-10.1-9.2-10.4L4.3,1.6C4.7,1,5,0.4,5.2-0.4l0,0c0.4-0.3,0.7-0.9,1-1.9   c0.3-1.1,0.3-1.9-0.1-2.3C6-4.8,5.9-4.9,5.8-4.9l0,0c0-0.1,0-0.3,0.1-0.5v0C6-5.5,6.1-5.7,6.1-5.8v0v-0.6l3.3-2.1   c0.1-0.1,0.2-0.2,0.2-0.4c0-0.2-0.1-0.3-0.2-0.4l0,0l-9.1-6.2c-0.1-0.1-0.2-0.1-0.3-0.1s-0.2,0-0.3,0.1l0,0l-9.3,6.4   c-0.1,0.1-0.2,0.2-0.2,0.4c0,0,0,0,0,0v0c0,0,0,0,0,0s0,0,0,0v0c0,0,0,0,0,0s0,0,0,0v0v5.1c-0.6,0.2-0.9,0.7-0.9,1.3   c0,0.8,0.6,1.4,1.4,1.4c0.8,0,1.4-0.6,1.4-1.4c0-0.6-0.4-1.1-0.9-1.3l0,0v-4.3l2.5,1.6v0.5c0,0.2,0.1,0.3,0.2,0.4l0,0   c0,0,0,0,0.1,0l0,0c0,0.1,0.1,0.3,0.1,0.5C-6-4.8-6.1-4.8-6.1-4.7l0,0c-0.4,0.4-0.4,1.2-0.1,2.3c0.3,1.1,0.6,1.7,1,1.9   C-5,0.4-4.7,1.1-4.3,1.7l0,0l-0.3,3.1c-1.8,0.3-9.2,2-9.2,10.4c0,0.3,0.2,0.5,0.5,0.5l0,0h26.7l0,0C13.6,15.7,13.9,15.4,13.9,15.2   C13.9,15.2,13.9,15.2,13.9,15.2L13.9,15.2L13.9,15.2z M-9.3-1.8c-0.3,0-0.5-0.2-0.5-0.5s0.2-0.5,0.5-0.5c0.3,0,0.5,0.2,0.5,0.5v0   c0,0,0,0,0,0C-8.8-2-9-1.8-9.3-1.8L-9.3-1.8L-9.3-1.8L-9.3-1.8z M-5.9-9.3C-6.1-9.2-6.2-9-6.2-8.8v1.4l-2.1-1.3L0-14.6L8.2-9   L6.1-7.6v-1.2c0-0.2-0.1-0.4-0.3-0.4l0,0c-1.7-0.6-3.7-1-5.8-1s-4.1,0.4-6,1.1L-5.9-9.3L-5.9-9.3z M5.1-8.5v2   C3.6-7,1.8-7.3-0.1-7.3S-3.7-7-5.4-6.5l0.1,0v-2C-3.7-9-1.9-9.3-0.1-9.3S3.6-9,5.2-8.4L5.1-8.5L5.1-8.5z M-4.7-1.2   c-0.1,0-0.3-0.3-0.6-1.4C-5.6-3.8-5.4-4-5.4-4.1c0,0,0,0,0.1,0s0,0,0.1,0h0c0,0,0,0,0,0C-5-4-4.8-4.3-4.8-4.5c0-0.1,0-0.1,0-0.2   l0,0C-4.8-4.8-4.9-5.2-5-5.5C-3.5-6-1.8-6.3-0.1-6.3C1.7-6.3,3.4-6,5-5.5l-0.1,0v0c0,0.3-0.1,0.6-0.1,0.8l0,0c0,0,0,0.1,0,0.2   c0,0.3,0.2,0.5,0.5,0.5c0,0,0,0,0,0h0c0,0,0,0,0.1,0s0,0,0.1,0h0c0,0,0.2,0.3-0.1,1.4C5-1.5,4.7-1.3,4.7-1.3   c-0.2,0-0.4,0.2-0.4,0.4v0C4.1,0.6,2.9,2.4,1.1,3.1C0.8,3.2,0.4,3.3,0,3.3s-0.8-0.1-1.1-0.2l0,0C-2.9,2.4-4,0.6-4.3-0.9   C-4.3-1.1-4.5-1.2-4.7-1.2L-4.7-1.2L-4.7-1.2z M-0.3,7.7l-0.6-1.3L0,5.7l0.9,0.7L0.3,7.7c0,0.1,0,0.1,0,0.2s0,0.1,0,0.2l0,0l1,2.4   l-0.9,2c-0.1,0.2-0.2,0.3-0.4,0.3s-0.4-0.1-0.4-0.3l0,0l-0.9-2l1-2.3c0-0.1,0-0.1,0-0.2S-0.3,7.8-0.3,7.7L-0.3,7.7L-0.3,7.7z    M1.3,7.9l0.6-1.4c0-0.1,0-0.1,0-0.2c0-0.2-0.1-0.3-0.2-0.4l0,0L0.3,4.7C0.2,4.7,0.1,4.6,0,4.6s-0.2,0-0.3,0.1l0,0l-1.5,1.2   C-1.9,6-1.9,6.1-1.9,6.3c0,0.1,0,0.1,0,0.2l0,0l0.6,1.4l-0.6,1.4l-1.8-4.2l0.3-2.4c0.5,0.5,1.2,1,1.9,1.2l0,0C-1,4.1-0.5,4.2,0,4.2   S1,4.1,1.5,4l0,0c0.8-0.3,1.4-0.7,2-1.3l0,0l0.3,2.4L1.9,9.3L1.3,7.9z M-12.9,14.7c0.3-7.3,6.8-8.7,8.4-9l3.2,7.1   c0.2,0.5,0.7,0.9,1.3,0.9c0.6,0,1.1-0.3,1.3-0.8l0,0l3.2-7.1c1.6,0.2,8.1,1.6,8.4,9L-12.9,14.7z"/>
                  </svg>
                  teachers
